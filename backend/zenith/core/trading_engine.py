...
from zenith.execution.abstract_broker import BrokerMode, Broker
...
from zenith.data.client import BinanceMarketClient, FakeMarketClient
from zenith.strategies.risk.manager import RiskManager
from zenith.core.signal_pipeline import prepare_signals
...
from zenith.common.utils.formatting import fmt_price
    ...
    def _build_broker(cfg, *, trade_logger: TradeLogger) -> Broker:
        ...
        if mode == BrokerMode.DRY_RUN:
            ...
            return DryRunBroker(
                ...
                symbols_allowlist=symbols_for_rules,
